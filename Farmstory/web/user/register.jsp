...
<script src="/Farmstory_war_exploded/js/zipcode.js"></script>
<script src="/Farmstory_war_exploded/js/validation.js"></script>
<script src="/Farmstory_war_exploded/js/checkUser.js"></script>
<div id="user">
	<section class="register">
        <form id="formUser" action="/Farmstory_war_exploded/user/registerProc.jsp" method="post">
            <table border="1">
