        ...
        <div id="container">
            <header>
                ...
                <p>
                    ...
                    <a href="/Farmstory2_war_exploded/admin/">관리자 |</a>
                    </c:if>
                    <a href="#">고객센터</a>
                </p>
                ...
                <ul class="gnb">
                    ...
                    <li><a href="/Farmstory2_war_exploded/board/list.do">농작물이야기</a></li>
                    <li><a href="/Farmstory2_war_exploded/board/list.do">이벤트</a></li>
                    <li><a href="/Farmstory2_war_exploded/board/list.do">커뮤니티</a></li>
                </ul>
            </header>
